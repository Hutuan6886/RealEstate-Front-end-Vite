    ...
    return (
        <>
            {openImageModal && dataListing && imgIndex && <div style={{ animation: 'zoomOut .3s linear' }} className="fixed z-30 w-full top-0 left-0">
                <ImageModal dataListing={dataListing} index={imgIndex} copyLink={copyLink} saveHomes={saveHomes} onClose={() => setOpenImageModal(false)} />
            </div>
            }
            ...
            <div className="fixed z-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 
                ...
                <div className="flex flex-row items-center justify-between p-3">
                    ...
                    <div className="flex flex-row items-center justify-end gap-3">
                        <Button variant="outline" className="flex flex-row items-center justify-center gap-2 font-semibold text-[1rem]"
                            onClick={copyLink}
                ...
                <div className="grid grid-cols-4 gap-1 overflow-hidden">
                    <div className={`col-span-4  ${currentUser.id !== dataListing?.userId ? "lg:col-span-3" : "lg:col-span-4"} overflow-y-scroll`}>
                    ...
                    {currentUser.id !== dataListing?.userId && <Fragment>
